...
// for(let i=0; i<0; i++)
// {
// 	bullets[i] = new GameObject({width:200, height:200})
// 	//bullets[i].img.src="images/mrt.jpg"
// 	bullets[i].makeSprite(playerData)
// 	bullets[i].y=-10000
// 	bullets[i].changeState(`smash`)
// }
...
// 			bullets[currentBullet].y = wiz.y + 25;
...
// 	{
// 		if(bullets[i].overlap(stage)) bullets[i].vy+=4;
// 		bullets[i].move()
...
//Very back background
var sky = new GameObject({x:0, y:200, width:4096, height:512, color:"cyan"})
sky.img.src = `images/sky_golem.png`
